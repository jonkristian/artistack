      ...
      <div class="space-y-4">
        ...
        <label class="flex cursor-pointer items-center justify-between">
          ...
          <button
            ...
            class="relative h-6 w-11 rounded-full transition-colors {soldOut
              ? 'bg-red-600'
              : 'bg-gray-700'}"
          >
            <span
              class="absolute top-0.5 left-0.5 h-5 w-5 rounded-full bg-white transition-transform {soldOut
                ? 'translate-x-5'
                : ''}"
            ></span>
          </button>
