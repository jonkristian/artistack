...
export const platformIcons: Record<string, string> = {
  ...
  // Not in Simple Icons, so drawn to match: Qobuz's record-shaped Q — a disc
  // with a label at the centre and a tail. Inner circle runs the other way
  // round so it cuts a hole under the default fill rule.
  qobuz:
    'M11 2a9 9 0 1 1 0 18a9 9 0 1 1 0-18zM11 4.5a6.5 6.5 0 1 0 0 13a6.5 6.5 0 1 0 0-13zM11 8.5a2.5 2.5 0 1 1 0 5a2.5 2.5 0 1 1 0-5zM14.2 16.2l2-2 3.6 3.6-2 2z',
  amazon_music:
...
const platformPatterns: Array<{ pattern: RegExp; platform: string; category: PlatformCategory }> = [
  ...
  { pattern: /qobuz\.com/i, platform: 'qobuz', category: 'streaming' },
 ...
 * yet — a release goes to Amazon and Pandora whether or not we recognise their
